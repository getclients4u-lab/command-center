...
const KNOWN = {
  ...
  "agent-ctl": { type: "service", restartUrl: "https://agent-dashboard-teal-psi.vercel.app/api/restart" },
  ...
  "marketing-integration": { type: "vercel", project: "marketing-integration-site", domain: "marketingintegrationllc.com" },
